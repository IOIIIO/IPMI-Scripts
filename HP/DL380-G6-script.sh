...
echo "dl380-g6.PSU1 ${PSU1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU2 ${PSU2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU.REDUN ${PSU_REDUN}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU1.FAIL ${PSU1_FAIL}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU2.FAIL ${PSU2_FAIL}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU1.PRES ${PSU1_PRES}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU2.PRES ${PSU2_PRES}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_1 ${FAN_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_2 ${FAN_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_3 ${FAN_3}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_4 ${FAN_4}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_5 ${FAN_5}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN_BLOCK_6 ${FAN_6}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.FAN.REDUN ${FAN_REDUN}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.AMBI_TEMP ${AMBI_TEMP}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU1_TEMP ${CPU1_TEMP}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU2_TEMP ${CPU2_TEMP}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU_ZONE_1 ${CPU_ZONE_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU_ZONE_2 ${CPU_ZONE_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU_ZONE_3 ${CPU_ZONE_3}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.CPU_ZONE_4 ${CPU_ZONE_4}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_1 ${MEM_ZONE_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_2 ${MEM_ZONE_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_3 ${MEM_ZONE_3}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_4 ${MEM_ZONE_4}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_5 ${MEM_ZONE_5}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_6 ${MEM_ZONE_6}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.MEM_ZONE_7 ${MEM_ZONE_7}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_1 ${IO_ZONE_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_2 ${IO_ZONE_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_3 ${IO_ZONE_3}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_4 ${IO_ZONE_4}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_5 ${IO_ZONE_5}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_6 ${IO_ZONE_6}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_7 ${IO_ZONE_7}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_8 ${IO_ZONE_8}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_9 ${IO_ZONE_9}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_10 ${IO_ZONE_10}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_11 ${IO_ZONE_11}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.IO_ZONE_12 ${IO_ZONE_12}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU_ZONE_1 ${PSU_ZONE_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.PSU_ZONE_2 ${PSU_ZONE_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl380-g6.SYS_ZONE ${SYS_ZONE}" | nc -q0 ${GRAPHITE_HOST} 2003
rm -rf ${IPMIOUT}
