...
FAN_2="$(grep "Fan 2" ${IPMIOUT} | awk ' {print $4} ')"
FAN_3="$(grep "Fan 3" ${IPMIOUT} | awk ' {print $4} ')"
FAN_4="$(grep "Fan 4" ${IPMIOUT} | awk ' {print $4} ')"
FAN_5="$(grep "Fan 5" ${IPMIOUT} | awk ' {print $4} ')"
FAN_6="$(grep "Fan 6" ${IPMIOUT} | awk ' {print $4} ')"
FAN_7="$(grep "Fan 7" ${IPMIOUT} | awk ' {print $4} ')"
AMBI_TEMP_1="$(grep -w "Temp 1" ${IPMIOUT} | awk ' {print $4} ')"
CPU1_TEMP="$(grep -w "Temp 2" ${IPMIOUT} | awk ' {print $4} ')"
CPU2_TEMP="$(grep -w "Temp 3" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_1="$(grep -w "Temp 4" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_2="$(grep -w "Temp 5" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_3="$(grep -w "Temp 6" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_4="$(grep -w "Temp 7" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_5="$(grep -w "Temp 8" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_6="$(grep -w "Temp 9" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_7="$(grep -w "Temp 10" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_8="$(grep -w "Temp 11" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_9="$(grep -w "Temp 12" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_10="$(grep -w "Temp 13" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_11="$(grep -w "Temp 14" ${IPMIOUT} | awk ' {print $4} ')"
MEM_ZONE_12="$(grep -w "Temp 15" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_1="$(grep -w "Temp 16" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_2="$(grep -w "Temp 17" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_3="$(grep -w "Temp 18" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_4="$(grep -w "Temp 19" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_5="$(grep -w "Temp 20" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_6="$(grep -w "Temp 21" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_7="$(grep -w "Temp 22" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_8="$(grep -w "Temp 23" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_9="$(grep -w "Temp 24" ${IPMIOUT} | awk ' {print $4} ')"
AMBI_TEMP_2="$(grep -w "Temp 25" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_10="$(grep -w "Temp 26" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_11="$(grep -w "Temp 27" ${IPMIOUT} | awk ' {print $4} ')"
SYS_ZONE_12="$(grep -w "Temp 28" ${IPMIOUT} | awk ' {print $4} ')"
STOR_ZONE="$(grep -w "Temp 29" ${IPMIOUT} | awk ' {print $4} ')"
AMBI_ZONE_3="$(grep -w "Temp 30" ${IPMIOUT} | awk ' {print $4} ')"
AMBI_ZONE_4="$(grep -w "Temp 31" ${IPMIOUT} | awk ' {print $4} ')"
...
# Sent to Graphite
echo "dl320-g6.FAN_BLOCK_1 ${FAN_1}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_2 ${FAN_2}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_3 ${FAN_3}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_4 ${FAN_4}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_5 ${FAN_5}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_6 ${FAN_6}" | nc -q0 ${GRAPHITE_HOST} 2003
echo "dl320-g6.FAN_BLOCK_7 ${FAN_7}" | nc -q0 ${GRAPHITE_HOST} 2003
